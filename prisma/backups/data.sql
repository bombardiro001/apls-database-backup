...
-- \restrict bPawBwiThQeddQ0MJz6RINgXsCnsUz4nLheTUz5JERQiQevpIAAOdbDvHkw1ifs
...
SELECT pg_catalog.setval('"auth"."refresh_tokens_id_seq"', 1225, true);
...
-- \unrestrict bPawBwiThQeddQ0MJz6RINgXsCnsUz4nLheTUz5JERQiQevpIAAOdbDvHkw1ifs
